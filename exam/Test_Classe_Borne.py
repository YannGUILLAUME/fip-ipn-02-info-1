...
cocktail._numberofCocktails = 5
cocktail._selectedCocktail = the_boost
cocktail._sizeof = TypeSize.Medium

#test valeurs

print(cocktail._selectedCocktail.name)
print(cocktail._numberofCocktails)
print(cocktail._sizeof.name)